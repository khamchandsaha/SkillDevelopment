...
<%
	...
	String institutionName="",mobileNumber="",password,insRegNum,email;
	try
	{
	...
	insRegNum = request.getParameter("insRegNumber");
	session.setAttribute("institutionName",institutionName);
	session.setAttribute("mobileNumber", mobileNumber);
	session.setAttribute("password", password);
	session.setAttribute("email", email);
	session.setAttribute("insRegNum", insRegNum);
	...
	String msg;
	msg = "Dear "+institutionName+" Your OTP for registration in Skill Development is: "+otp;
