...
<%
	...
	String companyName="",mobileNumber="",password,companyRegNum,email;
	try
	{
	...
	companyRegNum = request.getParameter("cmpRegNumber");
	session.setAttribute("companyName",companyName);
	session.setAttribute("mobileNumber", mobileNumber);
	session.setAttribute("password", password);
	session.setAttribute("email", email);
	session.setAttribute("companyRegNum", companyRegNum);
	...
	String msg;
	msg = "Dear "+companyName+" Your OTP for registration in Skill Development is: "+otp;
