...
<%@ page import="com.technoforensis.skilldevelopment.model.Institution" %>
...
<%
	...
	ins = (Institution) session.getAttribute("institute");
	mobileNumber = ins.getMobile();
	}
	catch (Exception e){
...
<div class="register-box">
  <div class="register-logo">
    <a href="<%=path %>/index.jsp"><b>Welcome</b>INSTITUTE</a>
  </div>
